...
@hydra.main(version_base="1.2", config_name="default", config_path="../config/lerobot")
...
def train_notebook(out_dir=None, job_name=None, config_name="default", config_path="../config/lerobot"):
